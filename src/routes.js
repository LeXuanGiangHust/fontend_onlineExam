...
const routes = [
  ...
  { path: '/exam', name: 'Exam', component: Exam, roles: ['admin', 'student'] },
  ...
  { path: '/field-question', name: 'Field Question', component: FieldQuestion, roles: ['admin'] },
  { path: '/manage-question', name: 'Manage Question', component: ManageQuestion, roles: ['admin'] },
